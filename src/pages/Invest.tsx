...
const Invest = () => {
  ...
  const [selectedCalculatorPlan, setSelectedCalculatorPlan] = useState<string>("");
  ...
  const { expectedProfit, totalReturn } = calculateReturns(investmentAmount, selectedCalculatorPlan);
    ...
    <div className="container mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Select the investment plan that best fits your financial goals and risk appetite. 
            All plans offer guaranteed returns and secure investment management.
          </p>
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-background/50 rounded-lg">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-xs md:text-sm text-muted-foreground">Total Investment</div>
                  <div className="text-lg font-bold">${investmentAmount.toLocaleString()}</div>
                </div>
                <div>
                  <div className="text-xs md:text-sm text-muted-foreground">Expected Profit</div>
                  <div className="text-lg font-bold text-success">${expectedProfit.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                </div>
                <div>
                  <div className="text-xs md:text-sm text-muted-foreground">Total Return</div>
                  <div className="text-lg font-bold text-primary">${totalReturn.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                </div>
              </div>
            </div>
          </CardContent>
