...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 selection:bg-primary/30">
      {/* Hero Section */}
      <section id="home" className="relative min-h-[60vh] md:min-h-[80vh] flex items-center pt-4 md:pt-8 pb-8 md:pb-12 overflow-hidden">
        ...
        <div className="relative container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6 md:space-y-8 text-left">
              ...
              <h1 className="text-4xl md:text-7xl font-black tracking-tighter leading-[0.95] uppercase italic">
                ELITE <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/signup" className="w-full sm:w-auto">
                  <Button className="w-full h-14 px-10 rounded-xl bg-primary text-primary-foreground font-black text-sm uppercase tracking-widest shadow-xl shadow-primary/20 hover:scale-105 transition-transform">
                    Start Trading <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
                <Link to="/invest" className="w-full sm:w-auto">
                  <Button variant="outline" className="w-full h-14 px-10 rounded-xl border-white/10 text-white font-black text-sm uppercase tracking-widest hover:bg-white/5">
                    View Market
                  </Button>
                </Link>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2 md:gap-3 pt-4">
                {commodities.map((item, i) => (
                    <div key={i} className="flex items-center gap-2 bg-white/5 backdrop-blur-md px-2 md:px-3 py-1.5 rounded-lg border border-white/5 hover:border-primary/40 transition-colors group">
                        <item.icon className={`h-3 md:h-4 w-3 md:w-4 ${item.color}`} />
            ...
            <div className="relative group block mt-4 lg:mt-0">
              ...
              <div className="relative border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
                <img src={teamExperts} alt="Experts" className="w-full h-[350px] md:h-[550px] object-cover grayscale-[0.2]" />
                  ...
                  <Card className="bg-slate-900/80 backdrop-blur-2xl border border-white/10 shadow-2xl">
                    <CardContent className="p-4 md:p-6 space-y-2 md:space-y-4">
                        <div className="flex justify-between items-center">
                            <Badge className="bg-emerald-500/20 text-emerald-400 border-emerald-500/20 px-3 py-0.5 text-[8px] md:text-[9px] font-black uppercase tracking-widest">Active Trade</Badge>
                            <span className="text-emerald-400 font-black text-lg md:text-xl tracking-tighter">+₦1,250,400</span>
                        </div>
                        <div className="space-y-1">
                            <h3 className="text-lg md:text-xl font-black text-white italic uppercase tracking-tight">Industrial Lithium</h3>
                            <p className="text-[8px] md:text-[10px] text-slate-400 font-bold uppercase tracking-widest">Secured by Global Ventures</p>
                        </div>
                    </CardContent>
                  </Card>
                </div>
      ...
      {/* Trust Ticker */}
      <section className="py-6 md:py-8 bg-white/[0.02] border-y border-white/5 overflow-hidden">
      ...
      <section id="features" className="py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="text-left mb-12 md:mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter uppercase italic text-white">THE <span className="text-primary">STANDARD</span> OF EXCELLENCE.</h2>
            ...
            {features.map((feature, index) => (
              <Card key={index} className="bg-slate-900/40 border border-white/5 hover:border-primary/30 transition-all duration-500 rounded-2xl overflow-hidden">
                <CardHeader className="p-6 md:p-8">
                  <div className="h-10 md:h-12 w-10 md:w-12 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
      ...
      <section className="py-8 md:py-12 px-6">
        <div className="container mx-auto">
          <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-white/10 rounded-[1.5rem] md:rounded-[2.5rem] p-8 md:p-16 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
              <div className="space-y-6 md:space-y-8 text-left">
                  <h2 className="text-3xl md:text-5xl font-black leading-tight text-white tracking-tighter uppercase italic">JOIN THE <br /> <span className="text-primary">PREMIUM</span> <br /> TRADING CIRCLE.</h2>
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Link to="/signup" className="w-full sm:w-auto">
                      <Button className="w-full h-12 px-10 rounded-xl bg-primary text-primary-foreground font-black text-sm uppercase tracking-widest shadow-lg">Get Started</Button>
                    </Link>
                    <Link to="/contact" className="w-full sm:w-auto">
                      <Button variant="outline" className="w-full h-12 px-10 rounded-xl border-white/20 text-white font-black text-sm uppercase tracking-widest">Inquire Now</Button>
                    </Link>
                  </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                  {stats.map((stat, i) => (
                      <div key={i} className="p-4 md:p-8 bg-white/[0.02] rounded-2xl border border-white/5 text-center">
                          <div className="text-2xl md:text-4xl font-black text-white mb-2 italic">{stat.number}</div>
                          <div className="text-slate-500 font-black uppercase tracking-widest text-[8px] md:text-[10px]">{stat.label}</div>
                      </div>
                  ))}
              </div>
            </div>
      ...
      <section id="testimonials" className="py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 md:mb-16 space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter uppercase italic text-white">VOICES OF THE ELITE.</h2>
          </div>
              ...
              <Card key={index} className="bg-slate-900/20 backdrop-blur-xl border border-white/5 rounded-[1.5rem] md:rounded-[2rem] hover:bg-slate-900/40 transition-all duration-700">
                <CardContent className="p-6 md:p-10 space-y-4 md:space-y-6">
                  ...
                  <div className="flex items-center gap-4 pt-4 md:pt-6 border-t border-white/5">
                    <img src={t.image} className="h-10 md:h-12 w-10 md:w-12 rounded-xl object-cover grayscale border border-white/10" />
                    <div>
                        <h4 className="font-black text-sm md:text-base text-white tracking-tight uppercase italic">{t.name}</h4>
                        <p className="text-[8px] md:text-[10px] text-primary font-black uppercase tracking-widest">{t.role}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <footer className="py-12 md:py-16 border-t border-white/5 bg-slate-950">
        <div className="container mx-auto px-4 text-center space-y-10">
          <div className="flex items-center justify-center gap-3">
              ...
              <span className="text-lg md:text-xl font-black tracking-tighter uppercase italic text-white">TERRASINVESTMENT</span>
          </div>
          ...
          <p className="text-slate-600 text-[8px] md:text-[10px] font-bold uppercase tracking-widest">© 2026 TERRASINVESTMENT. ELITE STATUS SECURED.</p>
        </div>
      </footer>
    </div>
  );
