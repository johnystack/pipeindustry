  ...
  const features = [
    {
      ...
      title: "High Returns",
      description:
        "Earn up to 15% monthly returns on your crypto investments with our proven strategies.",
    },
    {
      icon: Shield,
      title: "Secure Platform",
      description:
        "Your investments are protected with bank-level security and multi-layer encryption.",
    },
    {
      icon: Users,
      title: "Referral Program",
      description:
        "Earn additional income by referring friends and building your investment network.",
    },
    {
      icon: Zap,
      title: "Instant Withdrawals",
      description:
        "Access your earnings anytime with our fast and reliable withdrawal system.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "PipIndustry has transformed my financial future. I've earned consistent 12% monthly returns for over a year!",
    },
    {
      name: "Michael Chen",
      ...
      rating: 5,
      comment:
        "The platform's transparency and security features give me complete confidence in my investments.",
    },
    {
      name: "Emma Rodriguez",
      role: "Business Owner",
      ...
      rating: 5,
      comment:
        "Amazing referral program! I've earned $5,000+ just by sharing with friends. Highly recommended!",
    },
  ];
  ...
  const aboutFeatures = [
    {
      ...
      description:
        "Proven track record in cryptocurrency trading and investment management",
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      title: "Expert Team",
      description:
        "Professional traders and analysts with decades of combined experience",
    },
    {
      icon: TrendingUp,
      title: "Consistent Growth",
      description:
        "Delivering stable returns through bull and bear markets since 2019",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl leading-relaxed">
                Join thousands of investors earning consistent returns through
                our professional crypto investment platform. Start with as
                little as $100 and watch your wealth grow with our proven
                strategies.
              </p>
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                  <div className="bg-card/90 backdrop-blur-md rounded-xl p-4 md:p-6 border border-border">
                    <div className="flex items-center justify-between mb-2 md:mb-4">
                      ...
                      <span className="text-emerald-500 font-bold text-sm md:text-base">
                        +12.4%
                      </span>
                    </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              ...
              investment strategies to deliver consistent returns for our
              clients.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="bg-gradient-card border-border shadow-card hover-scale group"
              >
                <CardHeader>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Founded in 2019, PipIndustry has rapidly grown to become a
                leading and trusted cryptocurrency investment platform, serving
                a global community of over 15,000 active investors. Our mission
                is to democratize access to the lucrative world of crypto
                investments, providing a secure, transparent, and highly
                profitable environment for wealth creation. Our dedicated team
                comprises seasoned traders, financial analysts, and blockchain
                experts who leverage cutting-edge technology and proprietary
                algorithms to identify optimal investment opportunities and
                deliver consistent, superior returns for our clients, even in
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Real stories from real investors who have transformed their
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="bg-gradient-card border-border shadow-card hover-scale"
              >
                <CardHeader>
      ...
      <section id="contact" className="py-24 bg-gradient-subtle">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Whether you're new to crypto investing or a seasoned pro, our
              dedicated support team is here to assist you every step of the
              way. Reach out to us with any questions, feedback, or inquiries,
              and we'll ensure you receive prompt and comprehensive assistance.
      ...
      <section className="py-24 bg-gradient-primary relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-primary-foreground/90 mb-8 max-w-3xl mx-auto text-lg leading-relaxed">
            Join our community of successful investors and start earning passive
            income from cryptocurrency investments today. Get started with just
            $100 and watch your wealth grow.
          </p>
